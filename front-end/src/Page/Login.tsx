    ...
    <div className="w-[478px] h-[517px] bg-white border border-black rounded-lg flex flex-col items-center py-6 gap-4 mx-auto">
      ...
      <div className="w-[80%] flex flex-col gap-1">
        ...
        <input
          type="email"
          placeholder="Email"
          className="h-12 rounded-xl border border-black px-4 outline-none"
        />
      </div>
      ...
      <div className="w-[80%] flex flex-col gap-1 relative">
        ...
        <input
          ...
          className="h-12 rounded-xl border border-black px-4 pr-10 outline-none"
        />
        <button
          type="button"
      ...
      <div className="mt-2 text-sm">
        ...
        <span className="text-red-500 cursor-pointer">Register</span>
      </div>
    </div>
  );
}
